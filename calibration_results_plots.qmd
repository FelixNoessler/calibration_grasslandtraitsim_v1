---
title: "Calibration results for all plots"
...
For all calibration and validation plots, the observed data (black dots) and the simulation output (red and grey lines) are visualised. The red line represents the best and the grey lines the 25 best parameter combinations from the population. 
